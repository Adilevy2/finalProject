...
const Footer = () => {
  return (
    <footer className=" bg-sky-900	text-white	h-36">
      <div class="flex justify-center ">
        <div className="flex justify-between w-full m-2 mt-6">
          <div>
          ...
          <div>
            ...
            <div className="flex mr-12 mt-14">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="w-6 hover:scale-125 ease-in-out duration-300"
              >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="w-6 ml-4 hover:scale-125 ease-in-out duration-300"
              >
