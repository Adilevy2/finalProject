...
const PrivacyPolicy = () => (
  <div className="bg-gray-100 font-sans leading-normal  tracking-normal min-h-screen">
    ...
    <p className="my-4 rounded-lg shadow-lg text-center">
      This privacy policy sets out how [QRcontrol] uses and protects any
      information that you give QRcontrol when you use this website.
    </p>
    <p className="my-4 rounded-lg shadow-lg text-center">
      [QRcontrol] is committed to ensuring that your privacy is protected.
    ...
    <p className="my-4 ">
      [QRcontrol] may change this policy from time to time by updating this
      page. You should check this page from time to time to ensure that you are
      happy with any changes.
    </p>
    <h2 className="text-xl font-medium my-4 ">What we collect</h2>
    <p className="my-4 rounded-lg shadow-lg ">
    ...
    <h2 className="text-xl font-medium my-4">What we do with the information we gather</h2>
    <p className="my-4">
    ...
    <h2 className="text-xl font-medium my-4">Security</h2>
    <p className="my-4">
    ...
    <h2 className="text-xl font-medium my-4">How we use cookies</h2>
    <p className="my-4">
    ...
    <h2 className="text-xl font-medium my-4">Links to other websites</h2>
    <p className="my-4">
    ...
    <h2 className="text-xl font-medium my-4">Controlling your personal information</h2>
    <p className="my-4">
    ...
    <ul className="list-disc pl-5 my-4">
      ...
      <li>
        ...
        to or emailing us at [insert email address].
      </li>
    </ul>
    <p className="my-4">
      ...
      so. We may use your personal information to send you promotional information
    ...
    <p className="my-4">
      ...
      would like a copy of the information held on you please write to [insert      address].
    </p>
    <p className="my-4">
